...
<body>
	...
	include('common/connection.php'); // Include the database connection

	if (!empty($_SESSION['user_name'])) {
		$username = $_SESSION['user_name'];
		$query = "select id from user where fullname='$username'";
	...
	<div class="main-container">
		...
		<div class="inner-container">
			...
			<!-- box container2 end here -->
			
			<!-- google map container start here  -->
			<div class="google-map-container">
				<!-- inner map container start here -->
				<div class="inner-map-container">
					<p class="google-line">Google Weather Location Search Map</p>
					<iframe class="map-iframe" src="https://maps.google.com/maps?q=<?php echo $lat; ?>,<?php echo $lon; ?>&output=embed" ></iframe>
				</div>
				<!-- inner map container start here -->
			</div>
			<!-- google map container end here  -->
		</div>
