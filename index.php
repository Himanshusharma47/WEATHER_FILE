<?php
// connection file attached here
include('common/connection.php');

// first time registration code start here 
	...
	<div class="login-container">
		...
		<div class="reg-form">
			<form method="post">
				...
				<a href="signin.php"><input type="submit" class="login-btn" name="register" value="Register"></a>
			</form>
